<%-- 
    Document   : artist_img_upload
    Created on : Apr 23, 2025, 12:28:38 PM
              ...
              <div class="col-lg-8">
                  <div class="card">
                      <div class="card-header">
                          <h1 style="text-align:center;">Add Artist Image</h1>
                      </div>
                      <%
                      try{
                      ...
                      %>
                      <div class="card-body">
                          <form action="artist_upload_img.jsp?id=<%=code%>" method="post" enctype="multipart/form-data">
