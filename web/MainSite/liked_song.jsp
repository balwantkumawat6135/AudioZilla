<%-- 
    Document   : liked_song
    Created on : May 5, 2025, 7:46:22 PM
...
<%
    ...
    if (email != null && session.getAttribute(email) != null) {
        try {
            ...
            PreparedStatement ps = cn.prepareStatement("select count(sn) from liked_song where email=?");
                                    ...
                                    <table class="table table-hover" p_flag="1">
                                        ...
                                        <tbody>
                                            <%                                                int sn = 0;
                                                ...
                                                PreparedStatement s = cn.prepareStatement("select * from liked_song where  email=?");
                                                s.setString(1, email);
