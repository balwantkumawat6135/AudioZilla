...
<%
    String ccode=null;
    if(request.getParameter("id")!=null && request.getParameter("id").trim().length()>5 && request.getParameter("ccode")!=null && request.getParameter("ccode").trim().length()>5){
        ccode=request.getParameter("ccode");
        String id=request.getParameter("id");
        // Configure upload settings
        String UPLOAD_DIRECTORY = "album/"+id;
        ...
        response.sendRedirect("album.jsp?code="+ccode+"&success=1");
    }
    else{
        response.sendRedirect("album.jsp?code="+ccode+"&something_wrong=1");
    }
%>