<%-- 
    Document   : assigned_song
    Created on : May 9, 2025, 12:35:47 PM
              ...
              <div class="col-lg-12">
                  <div class="card mt-4">
                      <div class="card-header">
                          <h1 style="text-align:center;">Assigned Song </h1>
                      </div>
                      <div class="card-body">
                          <table class="table">
                              ...
                              <tbody>
                                  <%
                                      ...
                                      ResultSet rs=st.executeQuery("select * from songs where aname  LIKE '%"+ code +"%'");
                                      while(rs.next()){
