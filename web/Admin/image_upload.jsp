<%-- 
    Document   : Topic
    Created on : Sep 8, 2024, 12:50:22 PM
    Author     : BALWANT
--%>
              ...
              <div class="col-lg-8">
                  <div class="card">
                      <div class="card-header">
                          <h1 style="text-align:center;">Add Album Image</h1>
                      </div>
                      <%
                      try{
                        String ccode="";
                      ...
                      %>
                      <div class="card-body">
                          <form action="upload_image.jsp?id=<%=code%>&ccode=<%=ccode%>" method="post" enctype="multipart/form-data">
